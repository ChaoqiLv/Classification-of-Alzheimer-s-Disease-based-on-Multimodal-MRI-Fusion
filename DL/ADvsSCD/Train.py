...
class EarlyStopping:
    def __init__(self, patience=10, verbose=False, delta=0.0, save_dir='model_result', fold=0):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val':
                ...
                all_modal_preds = [[] for _ in range(4)]  # 4 modalities
                all_labels = []
...
if __name__ == "__main__":
    ...
    # Modify metrics collection dictionary in main program
    all_metrics = {
